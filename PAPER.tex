...
\path{src/executor/process\_manager.py}.
...
\path{src/executor/base\_batched\_compute\_task.py}.
...
\toprule\noalign{}
Workload & Configuration & Run 1 & Run 2 & Run 3 & Run 4 & Run 5 & Mean
& Std Dev & Source File \\
\midrule\noalign{}

\bottomrule\noalign{}

\textbf{Synthetic Load} & Razor\textquotesingle s Edge (best final
strategy) & 13.3 & 13.3 & 13.2 & 13.3 & 13.2 & 13.3 & 0.05 &
\path{demos/synthetic/dummy\ performance\ comparison\ basic.ipynb} \\
& No batching & 11.4 & 11.3 & 11.4 & 11.4 & 11.4 & 11.4 & 0.04 & \\
\textbf{BAAI/bge-m3 GPU} & Razor\textquotesingle s Edge (best final
strategy) & 35.8 & 35.5 & 36.3 & 34.4 & 34.4 & 35.3 & 0.76 &
\path{demos/real/gpu\ benchmark\ performance\ comparison.ipynb} \\
& No batching & 27.9 & 28.1 & 27.6 & 29.0 & 28.4 & 28.2 & 0.48 & \\
\textbf{BAAI/bge-m3 GPU (Limited tokens)} & Razor\textquotesingle s Edge
(best final strategy) & 85.1 & 82.8 & 83.3 & 86.0 & 85.9 & 84.6 & 1.33 &
\path{demos/real/gpu\ benchmark\ performance\ comparison.ipynb} \\
& Baseline (BS=10) & 68.1 & 69.0 & 68.3 & 66.0 & 65.5 & 67.4 & 1.37 & \\
& No batching & 42.0 & 37.9 & 45.5 & 41.1 & 40.6 & 41.4 & 2.46 & \\
\textbf{jinaai/jina-embeddings-v2-base-en CPU} & Razor\textquotesingle s
Edge (best final strategy) & 16.3 & 16.1 & 16.4 & 16.2 & 16.2 & 16.2 &
0.10 & \path{demos/cpu/cpu\ performance\ comparison\ basic.ipynb} \\
& Baseline (BS=2) & 11.0 & 10.9 & 11.0 & 11.0 & 10.9 & 11.0 & 0.05 & \\
& No batching & 10.5 & 10.8 & 10.5 & 10.2 & 10.7 & 10.5 & 0.21 & \\
\end{tabular}
\end{table*}

\hypertarget{latency-strategy-tables}{%
\paragraph{Latency strategy tables}\label{latency-strategy-tables}}

\hypertarget{synthetic-workload}{%
\subparagraph{Synthetic workload}\label{synthetic-workload}}

\begin{table*}[t]
\centering
\begin{tabular}{@{}llllll@{}}
\toprule\noalign{}
Strategy & RPS & Mean Latency & P95 Latency & P99 Latency & Max
Latency \\
\midrule\noalign{}
...
GUARDED\_BATCH\_SIZE & 12.766899 & 1.282302 & 2.700126 & 3.443307 &
3.660290 \\
\end{tabular}
\end{table*}

\hypertarget{baaibge-m3-gpu-workload-limited-tokens}{%
\subparagraph{BAAI/bge-m3 GPU Workload (limited
tokens)}\label{baaibge-m3-gpu-workload-limited-tokens}}
...
GUARDED\_BATCH\_SIZE & 24.498417 & 0.628991 & 0.974383 & 1.114459 &
1.183429 \\
\end{tabular}
\end{table*}

\hypertarget{jinaaijina-embeddings-v2-base-en-cpu-workload}{%
\subparagraph{jinaai/jina-embeddings-v2-base-en CPU
workload}\label{jinaaijina-embeddings-v2-base-en-cpu-workload}}
...
GUARDED\_BATCH\_SIZE & 30.585454 & 3.231145 & 6.223230 & 6.481141 &
6.545033 \\
\end{tabular}
\end{table*}
...
\tightlist
\item
  \path{demos/scheduler\_tests/save\_estimators\_for\_simulation.ipynb}
\end{itemize}
...
\item
  Razor\textquotesingle s Edge replay compares final strategies
...
\toprule\noalign{}
Workload & Best baseline RPS & Best Razor\textquotesingle s Edge
strategy & Best Razor\textquotesingle s Edge RPS & Replay uplift (\%) &
Paper claim uplift (\%) \\
\midrule\noalign{}
...
\texttt{BAAI/bge-m3} (GPU estimator replay) & 27.887 & \texttt{FIFO} &
37.490 & 34.44 & 26.00 \\
\texttt{jinaai/jina-embeddings-v2-base-en} (CPU estimator replay) &
...
\toprule\noalign{}
Workload & Fixed \texttt{n} used for A/B & A mean RPS & B mean RPS & C
...
36.601 & 31.368 \\
\texttt{jinaai/jina-embeddings-v2-base-en} replay & 1 & 3.488 & 3.488 &
...
\textbf{Notebook source:}
\path{demos/cpu/cpu\ performance\ comparison.ipynb}.
...
\textbf{Notebook source:}
\path{demos/real/razors\ edge\ gpu\ benchmark\ graphs.ipynb}.
...
transitivity checks) and figures, install dependencies from
\texttt{requirements.txt}, open each notebook in \path{demos/}, and
execute \textbf{Run All} from the first cell in a clean kernel.
Generated plots will be saved in \texttt{images/}.
...
\item
  \path{src/razors_edge/razors_edge_compute_task.py}
\item
  \path{src/executor/base_batched_compute_task.py}
\item
  \path{src/executor/process_manager.py}
\end{itemize}
